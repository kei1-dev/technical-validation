...
DEFAULT_PRIMARY_MODEL=${DEFAULT_PRIMARY_MODEL:-"us.anthropic.claude-sonnet-4-5-20250929-v1:0"}
DEFAULT_FAST_MODEL=${DEFAULT_FAST_MODEL:-"us.anthropic.claude-sonnet-4-5-20250929-v1:0"}
DEFAULT_FAST_MODEL_REGION=${DEFAULT_FAST_MODEL_REGION:-"${DEFAULT_REGION}"}
DEFAULT_MAX_OUTPUT_TOKENS=${DEFAULT_MAX_OUTPUT_TOKENS:-"16384"}
DEFAULT_MAX_THINKING_TOKENS=${DEFAULT_MAX_THINKING_TOKENS:-"2048"}
